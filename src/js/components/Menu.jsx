  ...
  return (
    ...
    >
      <ul className="hexMenu hexMenu--focusable">
        ...
        <li
          className="deviantart hex hex--z9 hex--animate hex--delay1 hex--hoverDelay0 hex--hoverOffsetX2 hex--hoverOffsetY0 hex--offsetX0 hex--offsetY0"
          tabIndex={2}
        >
          <a href="http://hertzahaeon.deviantart.com/" />
        </li>
        <li
          className="flickr hex hex--z8 hex--animate hex--delay0 hex--hoverDelay1 hex--hoverOffsetX4 hex--hoverOffsetY0 hex--offsetX2 hex--offsetY0"
          tabIndex={3}
        >
